...
export default function AdminBookingDetail() {
  ...
  const handleStatus = async (val: string) => {
    ...
    if (!ok) toast.error(useBookingStore.getState().error || "Failed to update status");
  };
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Select value={booking.status} onValueChange={(val) => void handleStatus(val)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  First assign from BOOKED sets SCHEDULED. Later statuses stay
                  unchanged when reassigning.
                </p>
              </div>
            </CardContent>
          </Card>
