...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-[13.5px] font-extrabold transition-all duration-150 disabled:pointer-events-none disabled:bg-[#f0f2f6] disabled:text-[#9aa0a6] [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-[#6cf3d5]/50",
  {
    variants: {
      variant: {
